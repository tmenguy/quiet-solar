...
async def test_setup_unload_home_entry_real_ha(hass: HomeAssistant, real_home_config_entry) -> None:
...
async def test_setup_entry_creates_data_handler(hass: HomeAssistant, real_home_config_entry) -> None:
...
async def test_reload_integration(hass: HomeAssistant, real_home_config_entry) -> None:
...
async def test_disabled_device_not_added_to_home(hass: HomeAssistant, setup_home_first) -> None:
...
async def test_ocpp_notification_listener_no_data_handler(hass: HomeAssistant) -> None:
    ...
    hass.bus.async_fire(
        "call_service",
        {
            "domain": PN_DOMAIN,
            "service": "create",
            "service_data": {"title": "OCPP Charger", "message": "Charger status update"},
        },
    )
    await hass.async_block_till_done()
...
async def test_is_notification_for_charger_matching_device_name(hass: HomeAssistant) -> None:
    ...
    with patch("homeassistant.helpers.device_registry.async_get") as mock_dev_reg:
        ...
        result = await _is_notification_for_charger(hass, "my charger device is connected", mock_charger)
...
async def test_is_notification_for_charger_matching_identifier(hass: HomeAssistant) -> None:
    ...
    with patch("homeassistant.helpers.device_registry.async_get") as mock_dev_reg:
        ...
        result = await _is_notification_for_charger(hass, "charger_id_456 is ready", mock_charger)
...
async def test_is_notification_for_charger_matching_qs_name(hass: HomeAssistant) -> None:
    ...
    with patch("homeassistant.helpers.device_registry.async_get") as mock_dev_reg:
        ...
        result = await _is_notification_for_charger(hass, "myocppcharger connected", mock_charger)
...
async def test_is_notification_for_charger_no_match(hass: HomeAssistant) -> None:
    ...
    with patch("homeassistant.helpers.device_registry.async_get") as mock_dev_reg:
        ...
        result = await _is_notification_for_charger(hass, "some unrelated message", mock_charger)
