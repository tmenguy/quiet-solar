...
class TestCars(unittest.TestCase):
    def test_cars_custom_data(self):
        ...
        car.update_dampening_value(
            amperage=(7, 3),
            amperage_transition=None,
            power_value_or_delta=20,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
        assert (
            car.car_charger_min_charge == 7
        )  # no dampening as car percent is None so we don't know teh state of teh car enpugh
    ...
    def test_dampening(self):
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((9, 3), (10, 3)),
            power_value_or_delta=501,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((9, 3), (12, 3)),
            power_value_or_delta=2000,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
    ...
    def test_dampening_phase_changes(self):
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((8, 1), (10, 3)),
            power_value_or_delta=4000,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((16, 1), (10, 3)),
            power_value_or_delta=2001,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((16, 1), (12, 3)),
            power_value_or_delta=3000,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((18, 1), (14, 3)),
            power_value_or_delta=5000,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
        ...
        car.update_dampening_value(
            amperage=None,
            amperage_transition=((21, 1), (18, 1)),
            power_value_or_delta=-750,
            time=datetime.datetime.now(),
            can_be_saved=False,
        )
