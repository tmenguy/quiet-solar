...
class TestQSChargerStatus(unittest.TestCase):
    ...
    def test_update_amps_with_delta(self):
        ...
        self.mock_charger.update_amps_with_delta.assert_called_once_with(from_amps=[10, 10, 10], delta=-5, is_3p=True)
...
class TestQSChargerGenericBasics(unittest.IsolatedAsyncioTestCase):
    ...
    def test_attach_car_replace_existing(self):
        ...
        with patch.object(charger, "detach_car") as mock_detach, patch.object(charger, "update_power_steps"):
...
class TestQSChargerWallbox(unittest.TestCase):
    ...
    def test_init_with_device(self):
        ...
        with (
            patch("custom_components.quiet_solar.ha_model.charger.entity_registry") as mock_entity_reg,
