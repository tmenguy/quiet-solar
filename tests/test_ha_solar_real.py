...
class _SeriesProvider(QSSolarProvider):
    ...
    async def get_power_series_from_orchestrator(self, orchestrator, start_time, end_time):
        return [(time, value) for time, value in orchestrator.power_series if start_time <= time <= end_time]
...
class TestQSSolarInit:
    ...
    def test_init_with_minimal_params(self, hass: HomeAssistant, solar_setup):
    ...
    def test_init_with_all_params(self, hass: HomeAssistant, solar_setup):
    ...
    def test_init_with_solcast_provider(self, hass: HomeAssistant, solar_setup):
    ...
    def test_init_with_openmeteo_provider(self, hass: HomeAssistant, solar_setup):
    ...
    def test_init_calculates_max_power_from_amps_single_phase(self, hass: HomeAssistant, solar_setup):
    ...
    def test_init_calculates_max_power_from_amps_three_phase(self, hass: HomeAssistant, solar_setup):
    ...
    def test_init_calculates_amps_from_power_single_phase(self, hass: HomeAssistant, solar_setup):
...
class TestQSSolarOverClamp:
    ...
    def test_over_clamp_production_below_max(self, hass: HomeAssistant, solar_setup):
    ...
    def test_over_clamp_production_above_max(self, hass: HomeAssistant, solar_setup):
    ...
    def test_over_clamp_at_exactly_max(self, hass: HomeAssistant, solar_setup):
...
class TestQSSolarForecast:
    ...
    @pytest.mark.asyncio
    async def test_update_forecast_with_provider(self, hass: HomeAssistant, solar_setup):
    ...
    @pytest.mark.asyncio
    async def test_update_forecast_without_provider(self, hass: HomeAssistant, solar_setup):
    ...
    def test_get_forecast_with_provider(self, hass: HomeAssistant, solar_setup):
    ...
    def test_get_forecast_without_provider(self, hass: HomeAssistant, solar_setup):
    ...
    def test_get_value_from_current_forecast_with_provider(self, hass: HomeAssistant, solar_setup):
        ...
        time = datetime.datetime.now(pytz.UTC)
        device.solar_forecast_provider_handler.get_value_from_current_forecast = MagicMock(return_value=(time, 1500.0))
    ...
    def test_get_value_from_current_forecast_without_provider(self, hass: HomeAssistant, solar_setup):
...
class TestQSSolarProviderBase:
    ...
    def test_get_value_from_current_forecast(self, hass: HomeAssistant, solar_mock):
...
class TestQSSolarProviderBaseExtended:
    ...
    @pytest.mark.asyncio
    async def test_fill_orchestrators_collects_non_none_entries(self, hass: HomeAssistant, solar_mock):
    ...
    @pytest.mark.asyncio
    async def test_extract_solar_forecast_aggregates_orchestrators(self, hass: HomeAssistant, solar_mock):
    ...
    @pytest.mark.asyncio
    async def test_update_time_gating(self, hass: HomeAssistant, solar_mock):
    ...
    @pytest.mark.asyncio
    async def test_update_logs_when_no_orchestrators(self, hass: HomeAssistant, solar_mock, caplog):
...
class TestQSSolarProviderSolcast:
    ...
    @pytest.mark.asyncio
    async def test_fill_orchestrators_no_entries(self, hass: HomeAssistant, solar_mock):
    ...
    @pytest.mark.asyncio
    async def test_fill_orchestrators_with_valid_entry(self, hass: HomeAssistant, solar_mock):
    ...
    @pytest.mark.asyncio
    async def test_fill_orchestrators_skips_invalid_entry(self, hass: HomeAssistant, solar_mock):
    ...
    @pytest.mark.asyncio
    async def test_get_power_series_handles_boundaries_and_timezone(self, solar_mock):
...
class TestQSSolarProviderOpenWeather:
    ...
    @pytest.mark.asyncio
    async def test_get_power_series_sorts_and_handles_boundaries(self, solar_mock):
...
class TestOrchestratorValidation:
    ...
    async def test_solcast_old_api_backward_compat(self, solar_mock):
        ...
        result = await provider.get_power_series_from_orchestrator(orchestrator, time, time + timedelta(hours=2))
        assert len(result) == 2
...
class TestQSSolarProviderSolcastDebug:
    ...
    async def test_get_power_series_returns_empty(self):
        ...
        try:
            ...
            time = datetime.datetime.now(pytz.UTC)
            result = await provider.get_power_series_from_orchestrator(MagicMock(), time, time + timedelta(hours=1))
...
class TestQSSolarDumpForDebug:
    ...
    @pytest.mark.asyncio
    async def test_dump_for_debug_with_provider(self, hass: HomeAssistant, solar_setup):
    ...
    @pytest.mark.asyncio
    async def test_dump_for_debug_without_provider(self, hass: HomeAssistant, solar_setup):
