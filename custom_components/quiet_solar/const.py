...
CONF_BATTERY_MIN_DISCHARGE_POWER_VALUE = "battery_min_discharge_power_value"
...
OVERRIDE_STATE_NO_OVERRIDE = "NO OVERRIDE"
OVERRIDE_STATE_ASKED_FOR_RESET = "ASKED FOR RESET OVERRIDE"
OVERRIDE_STATE_PREFIX = "Override: "
CONSTRAINT_ORIGINATOR_KEY = "originator"
CONSTRAINT_ORIGINATOR_USER_OVERRIDE = "user_override"
...
# Sentinel string returned by QSPerson.get_forecast_readable_string() when there
# is no mileage / leave-time prediction. Defined as a constant where it is
# produced (person.py) so the literal is not duplicated.
...
SENSOR_CAR_CHARGE_ORIGIN = "qs_car_charge_origin"
