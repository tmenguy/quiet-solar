...
**CLAUDE.md role**: CLAUDE.md is the Claude Code bootstrap file (auto-loaded at conversation start). It should contain only operational essentials (venv, commands) and point to `_qsprocess_opencode/project-context.md` and `_qsprocess_opencode/product/architecture.md` for the full rules. Do not duplicate content between CLAUDE.md and the project context files.
...
**AI Agent Guidelines:**
1. Read `_qsprocess_opencode/project-context.md` (42 code-level rules) AND this architecture document before implementing any code
